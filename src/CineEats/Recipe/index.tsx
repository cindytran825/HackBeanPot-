...
export default function Recipe() {
     return (
          <div >
               ...
               <div className="popular-title">Categories</div><br />
               <div>
                    <div className="category-alignment">
                         ...
                         <div>
                              <img style={{ width: 140, height: 140, left: 1410, top: 95, position: 'absolute', borderRadius: 100}} src="./images/Soup.png" />
                              <b style={{ left: 1440, top: 250, position: 'absolute', borderRadius: 100 }}>Soups</b>
                         </div>
                         <div>
                              <img style={{ width: 140, height: 140, left: 1580, top: 95, position: 'absolute', borderRadius: 100}} src="./images/Quick.png" />
                              <b style={{ left: 1600, top: 250, position: 'absolute', borderRadius: 100 }}>Quick Meals</b>
                         </div>
                         <div>
                              <img style={{ width: 140, height: 140, left: 1580, top: 95, position: 'absolute', borderRadius: 100}} src="./images/Holiday.png" />
                              <b style={{ left: 1600, top: 250, position: 'absolute', borderRadius: 100 }}>Holidays</b>
                         </div>
                    </div><br />
                    ...
                    <div className="card-alignment-second">
                         ...
                         <div style={{ width: 340, height: 106, left: 85, top: 650, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 25, fontWeight: '600', wordWrap: 'break-word' }}>Waffles</div>
                    ...
                    <div className="card-alignment-second">
                         ...
                         <img style={{ width: 415, height: 360, left: 1000, top: 250, position: 'absolute', borderTopLeftRadius: 10, borderTopRightRadius: 10 }} src="./images/Pancakes.png" />
                    </div><br />
